...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    class Meta:
        permissions = [
            ("view", "user has read permission"),
            ("create", "user has write permissions"),
            ("edit", "user has edit permissions")
        ]
        verbose_name = 'User'
...
class AdminUser(CustomUser):
    users = models.ManyToManyField(RegularUser, help_text="Select the users you manage",)
